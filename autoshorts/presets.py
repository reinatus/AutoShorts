...
PRESETS = {
    "lugares-extranos": ChannelPreset(
        ...
        bgm_volume=0.12,
        clip_duration=5,
        visual_style="realistic travel documentary, cinematic, mysterious, natural light, high detail, no text",
        editorial_rules=[
            ...
            "Priorizar nombres propios y localizaciones reales en las búsquedas visuales.",
